<div>
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-neural-900 dark:text-neural-100">Manage FeaturedSections</h1>
        <x-ui.button wire:navigate href="{{ route('admin.homepage.featured-sections.create') }}">Create New</x-ui.button>
    </div>
    <x-ui.card>
            ...
            <x-slot:body>
                ...
                <x-ui.table.row>
                    ...
                    <x-ui.table.cell class="text-right">
                        <x-ui.button size="sm" variant="secondary" wire:navigate href="{{ route('admin.homepage.featured-sections.edit', $record) }}">Edit</x-ui.button>
