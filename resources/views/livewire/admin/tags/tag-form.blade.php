<div>
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-neural-900 dark:text-neural-100">{{ $recordId ? 'Edit' : 'Create' }} Tag</h1>
        <x-ui.button wire:navigate variant="secondary" href="{{ route('admin.tags.index') }}">Back</x-ui.button>
    </div>
