...
>
    ...
    <div
        x-show="show"
        class="mb-6 bg-white dark:bg-slate-800 rounded-2xl overflow-hidden shadow-xl transform transition-all sm:w-full {{ $maxWidthClass }} sm:mx-auto border border-slate-200 dark:border-slate-700"
        x-transition:enter="ease-out duration-300"
    ...
    >
        ...
        @if(isset($footer))
            <div class="px-6 py-4 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-200 dark:border-slate-700 flex justify-end gap-2 rounded-b-2xl">
                {{ $footer }}
            </div>
        @endif
    </div>
