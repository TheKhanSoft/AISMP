    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen overflow-hidden">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-30 w-64 bg-white dark:bg-slate-800 border-r border-slate-200 dark:border-slate-700 transition-transform duration-300 lg:static lg:translate-x-0 lg:inset-auto overflow-y-auto flex flex-col">
            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center px-4 py-2 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg group">
                ...
                <div x-data="{ open: false }">
                    ...
                    <div x-show="open" x-collapse class="pl-11 pr-4 py-1 space-y-1">
                        <a href="{{ route('admin.pages.index') }}" class="block px-2 py-1.5 text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white">Pages</a>
                        <a href="{{ route('admin.hero-slides.index') }}" class="block px-2 py-1.5 text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white">Hero Slides</a>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }">
                    ...
                    <div x-show="open" x-collapse class="pl-11 pr-4 py-1 space-y-1">
                        <a href="{{ route('admin.users') }}" class="block px-2 py-1.5 text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white">All Users</a>
                    </div>
                </div>

                <a href="{{ route('admin.settings') }}" class="flex items-center px-4 py-2 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg group">
